...
```
docs/ux-spec/nextpartner_customer_center.md
```

**규칙**
- 고객센터 관련 작업 시 반드시 위 파일을 먼저 읽고 시작하세요.
- 기획안은 수시로 변경될 수 있으므로 캐시하지 말고 매 작업마다 파일을 직접 읽으세요.
- 기획안에 정의되지 않은 내용은 임의로 구현하지 말고 먼저 확인을 요청하세요.
